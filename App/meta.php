...
return array(
	...
	'accredetd-locksmith' => array(
		'title' => 'Accredetd Locksmith Conway -  Cerfified and Insured Locksmith in Conway, SC',
		'description' => 'Cerfified and Insured Locksmith in Conway, SC where provides residential locksmith, commercial locksmith, and car locksmith services including car key replacement, car lockout, module programming, lock repair, re-key locks, safe lockout, and more.', 
	),  

	'our-portfolio' => array(
		'layout' => 'gallery-layout',
		'title' => ' Conway Locksmith Portfolio (843) 920-4327 - Best Locksmith Conway, SC',
		'description' => ' Conway Locksmith provide fast and eficient locksmith services such as car key replacement ,car lockout, module programming, lock repair, re-key locks, safe lockout, and more',
	),
	    
	'customer-reviews' => array(
		'layout' => 'gallery-layout',
		'title' => 'Locksmith Reviews in Conway (843) 920-4327 - Conway Locksmith SC | Conway Locksmith is a A Local Conway Locksmith Company Providing All Locksmith Services in the Entire Conway Area',
		'description' => 'Read our clients reviews at Google Reviews and Yelp on Conway Locksmith Conway, SC areas',
	), 
	...
	'contact' => array(
		'title' => ' Conway Locksmith Contact (843) 920-4327 | Best Local Conway Locksmith Company',
		'description' => 'A local Conway licensed locksmith company provides 24 hour emergency professional locksmith services in Conway, SC area.',
		'layout' => 'contact-page',
	),
	...
	'services/home-lockout' => array(
		'title' => 'Home Lock Out Service Conway, SC (843) 920-4327 | Conway Locksmith',
		'description' => 'A Local Conway Locksmith Company Providing Home Lock Out (House Lockout) Services including apartment lock out, office lock out, and commercial lock out services entire Conway Area.',
	),
	...
	'services/car-ignition-repair' => array(
		'title' => 'Car Ignition Repair & Replacement Conway, SC | Conway Locksmithn',
		'description' => 'Our expert Conway Locksmith technician provides car ignition replacement and repair service at your Conway location, with car locksmith services like emergency car unlocking service and transponder key programming to ignition switch repair, car key replacement, car door lock repair and car key duplication.',
	),
	...
	'services/locked-out-of-house' => array(
		'title' => 'Home Lockout Service Conway, SC | Conway Locksmith | Locked Out Of Your House? We can Help!',
		'description' => 'What to do if you get locked out of your apartment? Call Conway Locksmith for lockout services Conway, SC Our 24 hour locksmiths are prepared to assist you!',
	),  

	'services/locked-out-of-business' => array(
		'title' => 'Commercial Lockout Services in Conway, SC | Conway Locksmith | Locked Out Of Your Business? | Expert Locksmith Technician',
		'description' => 'If you are locked out of your business, office or store Conway, SC, Conway Locksmith can help! We offer fast, 24/7 response for commercial lockouts.',
	),  
 
	'products' => array(
		'layout' => 'gallery-layout',
		'title' => ' Locksmith Products Conway | Residential and commercial locks, safes, intercoms and buzzers in Conway',
		'description' => 'At Conway Locksmith, Our inventory offers a variety of door hardware and security products to meet all your Conway, SC home and business security needs.',
	),
