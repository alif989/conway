...
Flight::set('flight.base_url', '/myrtlebeachlocksmith/'); ///this needs to be changed if website is in subdir ex. /website/
Flight::set('mainURL', 'http://' . $_SERVER['SERVER_NAME']); ///used for sitemap generator and Wordpress blog integration
###general settings


###mailing settings
Flight::set('fromMail', 'info@myrtlebeachlocksmith.net');
...
Flight::set('smtpUser', 'info@myrtlebeachlocksmith.net');
Flight::set('smtpPassword', ',DRLgSMGUF1X');
Flight::set('smtpHost', 'mail.myrtlebeachlocksmith.net');
