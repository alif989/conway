...
<h2 class="size-2 text-capitalize b-f font-weight-bold cw mb-4">Locksmith Services</h2>
<div class="service-carousel">
  <div class="service-item text-center">
    <a href="<?php  echo url('services/residential-locksmith'); ?>" title="Residential Locksmith">
      <img class="mb-3" src="<?php echo assets('img/services/Residential-Locksmith.jpg') ?>" alt="Residential Locksmith">
    </a>
    <span class="service_icon si-1"></span>
  ...
  <div class="service-item text-center">
    <a href="<?php  echo url('services/residential-locksmith'); ?>" title="Commercial Locksmith">
      <img class="mb-3" src="<?php echo assets('img/services/Commercial-Locksmith.jpg') ?>" alt="Commercial Locksmith">
    </a>

    <span class="service_icon si-2"></span>
    ...
    <p class="small-text cg">
      ...
      and intercom services, broken key extraction,
  ...
  <div class="service-item text-center">
    <a href="<?php  echo url('services/residential-locksmith'); ?>" title="Car Locksmith">
      <img class="mb-3" src="<?php echo assets('img/services/Car-Locksmith.jpg') ?>" alt="Car Locksmith">
    </a>
    <span class="service_icon si-3"></span>
  ...
  <div class="service-item text-center">
    <a href="<?php  echo url('services/residential-locksmith'); ?>" title="Emergency Locksmith">
      <img class="mb-3" src="<?php echo assets('img/services/Emergency-Locksmith.jpg') ?>" alt="Emergency Locksmith">
    </a>

    <span class="service_icon si-4"></span>
    <h3 class="mt-3 mb-3 b-f cw">Emergency Locksmith</h3>
