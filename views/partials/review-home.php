    ...
    <div class="col-md-5 align-self-center">
      <div class="text-box p-2">
        ...
        <div class="d-flex div mt-lg-5">
          <div>
              <a class="d-inline-block mr-3" href="#" title="Conway Locksmith SC on Google Reviews" target="_blank">
              <span class="d-inline-block credit-icons ci-gfs"></span>
            </a> 
          </div>
          <div>
              <a class="d-inline-block mr-3" href="https://www.yelp.com/" title="Conway Locksmith SC on Google Reviews" target="_blank">
