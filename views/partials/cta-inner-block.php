<div class="requestService hd-bg">
    ...
    <ul class="list-inline d-flex justify-content-center align-items-center">
        ...
        <li class="pl-0 pr-0 pl-sm-3 pr-sm-3 pl-md-5 pr-md-5 pl-lg-5 pr-lg-5  pl-xl-5 pr-xl-5">
            <p class="text-white">or</p>
        </li>
        <li>
        <a href="#" title="Get a Quote" class="button button_primary  d-flex align-items-center text-white cta_button" id="cta_button" data-toggle="modal" data-target="#quote-popup">
         GET A QUOTE</a>
     </li>
    </ul>
</div> 