<?php Flight::set('innerPageBannerTitle', 'Privacy')?>
...
<p>Note: the privacy practices set forth in this privacy policy are for website only. If you link to other web sites, please review the privacy policies posted at those sites.</p>

<h2 class="mb-2">Collection of Information</h2>
<p>We collect personally identifiable information, like names, postal addresses, email addresses, etc., when voluntarily submitted by our visitors. The information you provide is used to fulfill you specific request. This information is only used to fulfill your specific request, unless you give us permission to use it in another manner, for example to add you to one of our mailing lists.

<h2 class="mb-2">Cookie/Tracking Technology</h2>
...
<h2 class="mb-2">Distribution of Information</h2>
...
<h2 class="mb-2">Commitment to Data Security</h2>
...
<h2 class="mb-2">Privacy Contact Information</h2>
...
<h4 class="text-uppercase lead mb-0 pb-0">Address:</h4 class="text-uppercase lead mb-0 pb-0"> 
...
<p>	<h4 class="text-uppercase lead mb-0 pb-0">Phone:	</h4 class="text-uppercase lead mb-0 pb-0"> 
		<a class="text-dark" href="tel:<?php echo Flight::get('phone'); ?>" title="call">
			<i class="fal fa-phone text-dark"></i>  <?php echo phone(true, false); ?>			
	</a>	  
</p>

<p>	<h4 class="text-uppercase lead mb-0 pb-0">E-mail:	</h4 class="text-uppercase lead mb-0 pb-0"> 

		<a class="text-lowercase text-dark"  href="mailto:<?php echo Flight::get('fromMail'); ?>" title="E-mail">
		<i class="fal fa-envelope text-dark"></i> <?php echo Flight::get('fromMail'); ?></a> 
</p>
